...
import Header from 'src/components/Header/HeaderBase'
...
const PolicyPage = () => {
  ...
  return (
    <div className="m-1">
      <Header />
      <h1 className="text-3xl mt-20">Privacy Policy of Asymmatrix</h1>

      <div>Asymmatrix operates the https://storygate-v2.netlify.app/ website, which provides the SERVICE.</div>
      ...
      <div>
        ...
        if anyone decided to use our Service, the StoryGate website.
      </div>
      ...
      <div>
        ...
        https://storygate-v2.netlify.app/, unless otherwise defined in this Privacy Policy. Our Privacy Policy was created with the help of
        the <a href="https://www.privacypolicytemplate.net">Privacy Policy Template</a> and the{' '}
      ...
      <h2 className="text-2xl">Log Data</h2>
      ...
      <div>
        ...
        Data. This Log Data may include information such as your computer’s Internet Protocol ("IP") address, browser version, pages of our
      ...
      <div>
        Our website uses these "cookies" to collection information and to improve our Service. You have the option to either accept or
      ...
      <div>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us.</div>
      <Footer />
    </div>
  )
}
