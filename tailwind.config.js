module.exports = {
  ...
  theme: {
    ...
    // -> describe liner-gradient directly on code
    // background gradient
    ...
    linearGradientColors: {
      // defaults to {}
      red: '#f00',
      'gray500-primary-gray500': ['#a0aec0 10%', 'var(--color-primary)', '#a0aec0 90%'],
      'gray700-primary-gray700': ['#4a5568 10%', 'var(--color-primary)', '#4a5568 90%'],
      'gray900-primary-gray900': ['#1a202c 10%', 'var(--color-primary)', '#1a202c 90%'],
      'gray500-secondary-gray500': ['#a0aec0 10%', 'var(--color-secondary)', '#a0aec0 90%'],
    ...
    boxShadow: {
      ...
      '2xl-c': '10px 25px 25px -2px rgba(0, 0, 0, .25)',
